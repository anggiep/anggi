...
class PenggunaController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pengguna.id LIKE ? OR 
				pengguna.name LIKE ? OR 
				pengguna.email LIKE ? OR 
				pengguna.id_role LIKE ? OR 
				pengguna.password LIKE ? OR 
				pengguna.image LIKE ? OR 
				pengguna.remember_token LIKE ? OR 
				pengguna.created_at LIKE ? OR 
				pengguna.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","id_role","password","image","remember_token","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","id_role","image","remember_token","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
